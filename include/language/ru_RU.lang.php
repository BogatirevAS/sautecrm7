...
$app_strings = array(
    ...
    'DEFAULT' => 'Основные данные', //Can be translated in all caps. This string will be used by SuiteP template menu actions
    'LBL_SORT' => 'Сортировка',
    ...
    'ERR_NO_DB' => 'Невозможно установить соединение с базой данных. Более подробная информация находится в файле suitecrm.log (0).',
    ...
    'LBL_PANEL_ASSIGNMENT' => 'Другое', //Can be translated in all caps. This string will be used by SuiteP template menu actions
    'LBL_PANEL_ADVANCED' => 'Подробная информация', //Can be translated in all caps. This string will be used by SuiteP template menu actions
    ...
    'LBL_ACCESSKEY_CLEAR_RELATE_LABEL' => 'Очистить выделение',
    'LBL_ACCESSKEY_CLEAR_COLLECTION_KEY' => ' ',
    'LBL_ACCESSKEY_CLEAR_COLLECTION_TITLE' => 'Очистить выделение',
    'LBL_ACCESSKEY_CLEAR_COLLECTION_LABEL' => 'Очистить выделение',
    ...
    'LBL_ACCESSKEY_CLEAR_ACCOUNTS_TITLE' => 'Очистить аккаунт',
    'LBL_ACCESSKEY_CLEAR_ACCOUNTS_LABEL' => 'Очистить аккаунт',
    ...
    'LBL_ACCESSKEY_CLEAR_CAMPAIGNS_TITLE' => 'Очистить кампанию',
    'LBL_ACCESSKEY_CLEAR_CAMPAIGNS_LABEL' => 'Очистить кампанию',
    ...
    'LBL_ACCESSKEY_CLEAR_TEAMS_TITLE' => 'Очистить команду',
    'LBL_ACCESSKEY_CLEAR_TEAMS_LABEL' => 'Очистить команду',
