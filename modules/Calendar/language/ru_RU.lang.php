...
$mod_strings = array(
    ...
    'LBL_STYLE_BASIC' => 'Основной', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
    'LBL_STYLE_ADVANCED' => 'Расширенный', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
