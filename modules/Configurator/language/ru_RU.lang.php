...
$mod_strings = array(
    ...
    'LBL_LDAP_SERVER_HOSTNAME_DESC' => 'Пример:<br>ldap://ldap.example.com:389 или<br>ldaps://ldap.example.com:636 для SSL<br>Разделите несколько хостов пробелами.',
    ...
    'LBL_STACK_TRACE' => 'Включить последовательность вызовов',
...
// Wizard
    ...
    // Google auth PR 6146
    'LBL_GOOGLE_AUTH_TITLE' => 'Авторизация через Google',
    'LBL_GOOGLE_AUTH_JSON' => 'JSON файл',
    'LBL_GOOGLE_AUTH_JSON_HELP' => 'Загрузите файл JSON, который вы скачали из консоли Google Developers.',
