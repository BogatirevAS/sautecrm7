...
//ABOUT page
    ...
    'LBL_EDIT_ALL_RECURRENCES' => 'Редактировать все повторы',
    'LBL_REMOVE_ALL_RECURRENCES' => 'Удалить все повторы',
    ...
    'LBL_ELASTIC_SEARCH_EXCEPTION_SEARCH_ENGINE_NOT_FOUND' => 'Не удается найти запрошенную поисковую систему. Попробуйте повторить поиск.',
    ...
    'LBL_ELASTIC_SEARCH_EXCEPTION_END_MESSAGE' => 'Свяжитесь с администратором, если проблема не устранена. Более подробная информация доступна в логах.',

    'LBL_ELASTIC_SEARCH_DEFAULT' => 'Нет результатов совпадений с условиями поиска. Попробуйте расширить свой поиск.',
