...
',
  ...
  'LBL_GOOGLE_SUITE_ADMIN_DESC' => 'Управление вашей интеграцией с Google Suite.',
  ...
  'LBL_JJWG_MAPS_ADMIN_ADDRESS_CACHE_DESC' => 'Предоставляет доступ к кэшу адресов. Это только кэш.',
  'LBL_GOOGLE_AUTH_TITLE' => 'Google Sync Settings',
  'LBL_GOOGLE_CALENDAR_SETTINGS_TITLE' => 'Настройки календаря Google',
  'LBL_GOOGLE_CALENDAR_SETTINGS_DESC' => 'Configuration settings to adjust your Google Calendar',
  'LBL_GOOGLE_CALENDAR_SETTINGS_JSON' => 'Загрузить файл учетных данных Google API',
  ...
  'LBL_SEARCH_WRAPPER_DESC' => 'Настройка глобальных настроек поиска для системы',
  'LBL_ELASTIC_SEARCH' => 'Эластичный поиск',
  'LBL_ELASTIC_SEARCH_SETTINGS' => 'Эластичный поиск',
  ...
  'LBL_ELASTIC_SEARCH_INDEX_SCHEDULE_PART_SUCCESS' => 'Была запланирована частичная индексация и начнется в течение следующих 60 секунд.',
  'LBL_ELASTIC_SEARCH_INDEX_SCHEDULE_PART_FAIL' => 'Failed to start partial index.',
  'LBL_SEARCH_INTERFACE' => 'Интерфейс поиска',
  'LBL_SEARCH_ENGINE' => 'Поисковая система',
  'LBL_SEARCH_ENGINE_HELP' => 'Настройка поисковой системы по умолчанию, используемой поиском.',
  'LBL_SEARCH_ENGINE_TOOLTIP' => 'Выбор поисковой системы для глобального поиска.',
  'LBL_SEARCH_GENERAL' => 'Основные настройки',
  ...
  'LBL_SIMPLE_SQL_SEARCH_ENGINE' => 'Простая поисковая система SQL',
  'LBL_AJAX_SUBMIT_FAIL' => 'При сохранении настроек произошла ошибка.',
);