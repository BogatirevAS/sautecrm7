...
$mod_strings = array (
  ...
  'LBL_BUTTON_DELETE_IMAP' => 'Удалить из IMAP',
  ...
  'LBL_QUICK_CREATE_SUCCESS1' => 'Запись успешно создана.',
  'LBL_QUICK_CREATE_SUCCESS2' => 'Нажмите кнопку ОК для просмотра новой записи.',
  'LBL_QUICK_CREATE_SUCCESS3' => 'Нажмите кнопку Отмена, чтобы вернуться к электронной почте.',
  ...
  'ERR_FIELD_FROM_IS_NOT_SET' => 'Поле From не задано.',
  'ERR_FIELD_FROM_IS_EMPTY' => 'From field is empty.',
  'ERR_FIELD_FROM_IS_INVALID' => 'From field is invalid.',
  'ERR_FIELD_FROM_ADDR_IS_NOT_SET' => 'Адрес не установлен.',
  'ERR_FIELD_FROM_ADDR_IS_EMPTY' => 'Адрес пуст.',
  'ERR_FIELD_FROM_ADDR_IS_INVALID' => 'Адрес указан неверно.',
  ...
  'ERR_FIELD_FROM_ADDR_NAME_IS_NOT_SET' => 'Не задана пара адресов и имени.',
  'ERR_FIELD_FROM_ADDR_NAME_IS_EMPTY' => 'Адрес и имя пара должны быть заполнены.',
  'ERR_FIELD_FROM_ADDR_NAME_IS_INVALID' => 'Неправильная пара адресов и имени.',
  'ERR_FIELD_FROM_ADDR_NAME_DOESNT_MATCH_REGEX' => 'Некорректный формат пары адресов и имени. Используйте формат "from@emailaddress.org <Name of Person>".',
