...
<div class="row">
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='date_entered_advanced'>{sugar_translate label='LBL_DATE_ENTERED' module='cstm_TestMessages'}</label>
                            </div>
            <div class="form-item">
...
{rdelim}
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='message_advanced'>{sugar_translate label='LBL_MESSAGE' module='cstm_TestMessages'}</label>
                            </div>
            <div class="form-item">
                                
{if strlen($fields.message_advanced.value) <= 0}
{assign var="value" value=$fields.message_advanced.default_value }
{else}
{assign var="value" value=$fields.message_advanced.value }
{/if}
<input type='text' name='{$fields.message_advanced.name}'
    id='{$fields.message_advanced.name}' size='30'
