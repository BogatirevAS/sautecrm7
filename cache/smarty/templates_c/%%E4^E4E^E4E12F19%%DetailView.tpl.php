<?php /* Smarty version 2.6.33, created on 2023-03-05 14:42:59
         compiled from cache/themes/SuiteP/modules/cstm_TestMessages/DetailView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/themes/SuiteP/modules/cstm_TestMessages/DetailView.tpl', 40, false),array('function', 'sugar_translate', 'cache/themes/SuiteP/modules/cstm_TestMessages/DetailView.tpl', 49, false),array('function', 'counter', 'cache/themes/SuiteP/modules/cstm_TestMessages/DetailView.tpl', 107, false),array('modifier', 'strip_semicolon', 'cache/themes/SuiteP/modules/cstm_TestMessages/DetailView.tpl', 100, false),)), $this); ?>
...
" class="button primary" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='cstm_TestMessages'; _form.return_action.value='DetailView'; _form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='cstm_TestMessages'; _form.return_action.value='DetailView'; _form.isDuplicate.value=true; _form.action.value='EditView'; _form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='cstm_TestMessages'; _form.return_action.value='ListView'; _form.action.value='Delete'; if(confirm('<?php echo $this->_tpl_vars['APP']['NTC_DELETE_CONFIRMATION']; ?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='cstm_TestMessages'; _form.return_action.value='DetailView'; _form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_DATE_ENTERED','module' => 'cstm_TestMessages'), $this);?>
...
<?php if (! $this->_tpl_vars['fields']['message']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>
...
<?php endif; ?> 
<span class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['message']['name']; ?>
"><?php echo $this->_tpl_vars['fields']['message']['value']; ?>
</span>
<?php endif; ?>
